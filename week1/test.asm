...
0000000000001050 <_start>:
    ...
    1064:	48 8d 3d f5 00 00 00 	lea    0xf5(%rip),%rdi        # 1160 <main>
...
void foo(int x) {
    ...
    1149:	48 8d 05 b4 0e 00 00 	lea    0xeb4(%rip),%rax        # 2004 <_IO_stdin_used+0x4>
...
int main() {
    ...
    116f:	eb 0e                	jmp    117f <main+0x1f>
        foo(i);
    1171:	8b 45 fc             	mov    -0x4(%rbp),%eax
    1174:	89 c7                	mov    %eax,%edi
    1176:	e8 be ff ff ff       	call   1139 <foo>
    for (int i = 0; i < 3; i++) {
    117b:	83 45 fc 01          	addl   $0x1,-0x4(%rbp)
    117f:	83 7d fc 02          	cmpl   $0x2,-0x4(%rbp)
    1183:	7e ec                	jle    1171 <main+0x11>
    }
    return 0;
